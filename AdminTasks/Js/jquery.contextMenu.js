                ...
                $(this).mousedown(function (e) {
                    ...
                    $(this).mouseup(function (e) {
                        ...
                        if (evt.button == 2) {
                            ...
                            //var clientVal = e.clientX + d.scrollLeft; 
                            var clientVal;
                            if (d.scrollLeft == undefined)
                                clientVal = e.clientX - 220;
                            else
                                clientVal = e.clientX + d.scrollLeft;
                            //(e.pageX) ? z = e.pageX : x = e.clientX + d.scrollLeft;
                            x = clientVal;
                            (e.pageY) ? y = e.pageY : x = e.clientY + d.scrollTop;

                            // Show the menu
                            $(document).unbind('click');
                            $(menu).css({ top: y, left: 150 }).fadeIn(o.inSpeed);
                            // Hover events
